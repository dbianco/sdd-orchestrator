...
const registrars: Registrar[] = [registerRouteTask, registerStartFeature, registerGetContext, registerAdvancePhase, registerGetFeatureStatus, registerListFeatures, registerSearchMemory, registerProposeMemory, registerResources];
